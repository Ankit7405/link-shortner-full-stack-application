    ...
    <div className="min-h-[calc(100vh-64px)] flex justify-center items-center">
      ...
      >
        ...
        <button
          disabled={loader}
          type="submit"
          className="bg-[#3364F7] font-semibold text-white  bg-gradient-to-r from-blue-500 to-purple-600 w-full py-2 hover:text-slate-400 transition-colors duration-100 my-3 rounded-sm"
        >
